...
class PrescriptionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'ward': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., Pulmonology Ward'}),
            'ipd_prescription': forms.Textarea(attrs={'class': 'form-control ipd-textarea', 'rows': 4, 'placeholder': 'Type IPD prescription or orders here...'}),
